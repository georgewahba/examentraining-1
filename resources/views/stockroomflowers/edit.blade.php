...
@section('content')
<div class="container">
     <form action="/stockroomflowers/editname/{{ $stockroom->id }}" enctype="multipart/form-data" method="post">
            @csrf
            ...
            <div class="row">
                <div class="col-8 offset-2">
                    ...
                    <div>
                        ...
                        <input type="hidden" name="stockroomflowerid" value ="{{$stockroom->id}}">
                    </div>
                    <div>
         ...
         <div class="row">
             <button class="btn btn-primary offset-2" type="submit">edit amount</button>
         </div>
    </form>
@endsection